...
do
	...
	do
		...
		function RequestBuilder:url(url)
			return
		end
		...
		---@param value string
		---@return RequestBuilder
		function RequestBuilder:addHeader(name, value)
			return
		end

		---@param body string
		---@return RequestBuilder
		function RequestBuilder:post(body)
			return
		end

		---@param headers Headers
		---@return RequestBuilder
		function RequestBuilder:headers(headers)
			return
		end

		---@param cacheControl CacheControl
		---@return RequestBuilder
		function RequestBuilder:cacheControl(cacheControl)
			return
		end

		---@return RequestBuilder
		function RequestBuilder:get()
			return
		end
	end
	...
	do
		...
		---@return Headers
		function HeadersBuilder:build()
			return
		end

		---@param name string
		---@return string
		function HeadersBuilder:get(name)
			return
		end
		...
		function HeadersBuilder:add(name, value)
		end

		---@param name string
		---@param value string
		---@return HeadersBuilder
		function HeadersBuilder:set(name, value)
		end
	end
	...
	do
		...
		---@return RequestBody
		function FormBodyBuilder:build()
			return
		end
		...
		function FormBodyBuilder:add(name, value)
			return
		end
	end
...
do
	...
	---@param title string
	---@return void
	function NovelInfo:setTitle(title)
		return
	end
	...
	---@return void
	function NovelInfo:setDescription(description)
		return
	end

	---@param genres Array | table
	---@return void
	function NovelInfo:setGenres(genres)
		return
	end

	---@param authors Array | table
	---@return void
	function NovelInfo:setAuthors(authors)
		return
	end

	---@param status "NovelStatus(3)" | NovelStatus
	---@return void
	function NovelInfo:setStatus(status)
		return
	end

	---@param tags Array | table
	---@return void
	function NovelInfo:setTags(tags)
		return
	end

	---@param artists Array | table
	---@return void
	function NovelInfo:setArtists(artists)
		return
	end

	---@param language string
	---@return void
	function NovelInfo:setLanguage(language)
		return
	end

	---@param chapters ArrayList
	---@return void
	function NovelInfo:setChapters(chapters)
		return
	end
end
...
do
	...
	do
		...
		---@param cacheControl CacheControl
		---@return Request
		function GET(url, headers, cacheControl)
			return
		end
		...
		---@param cacheControl CacheControl
		---@return Request
		function POST(url, headers, body, cacheControl)
			return
		end
		...
		---@return CacheControl
		function DEFAULT_CACHE_CONTROL()
			return
		end
		---@return Headers

...
--https://www.royalroad.com/fictions/search?title=world&minPages=&maxPages=&minRating=&maxRating=&dir=asc
	...
	searchFilters = {
		...
		FilterGroup("Genres [TODO: TriStateFilter]", {
			CheckboxFilter(201, GENRES_FILTER_EXT[01]),
			CheckboxFilter(202, GENRES_FILTER_EXT[02]),
			CheckboxFilter(203, GENRES_FILTER_EXT[03]),
			CheckboxFilter(204, GENRES_FILTER_EXT[04]),
			CheckboxFilter(205, GENRES_FILTER_EXT[05]),
			CheckboxFilter(206, GENRES_FILTER_EXT[06]),
			CheckboxFilter(207, GENRES_FILTER_EXT[07]),
			CheckboxFilter(208, GENRES_FILTER_EXT[08]),
			CheckboxFilter(209, GENRES_FILTER_EXT[09]),
			CheckboxFilter(210, GENRES_FILTER_EXT[10]),
			CheckboxFilter(211, GENRES_FILTER_EXT[11]),
			CheckboxFilter(212, GENRES_FILTER_EXT[12]),
			CheckboxFilter(213, GENRES_FILTER_EXT[13]),
			CheckboxFilter(214, GENRES_FILTER_EXT[14]),
			CheckboxFilter(215, GENRES_FILTER_EXT[15]),
		}),
		FilterGroup("Additional Tags [TODO: TriStateFilter]", {
			CheckboxFilter(301, TAGS_FILTER_EXT[01]),
			CheckboxFilter(302, TAGS_FILTER_EXT[02]),
			CheckboxFilter(303, TAGS_FILTER_EXT[03]),
			CheckboxFilter(304, TAGS_FILTER_EXT[04]),
			CheckboxFilter(305, TAGS_FILTER_EXT[05]),
			CheckboxFilter(306, TAGS_FILTER_EXT[06]),
			CheckboxFilter(307, TAGS_FILTER_EXT[07]),
			CheckboxFilter(308, TAGS_FILTER_EXT[08]),
			CheckboxFilter(309, TAGS_FILTER_EXT[09]),
			CheckboxFilter(310, TAGS_FILTER_EXT[10]),
			CheckboxFilter(311, TAGS_FILTER_EXT[11]),
			CheckboxFilter(312, TAGS_FILTER_EXT[12]),
			CheckboxFilter(313, TAGS_FILTER_EXT[13]),
			CheckboxFilter(314, TAGS_FILTER_EXT[14]),
			CheckboxFilter(315, TAGS_FILTER_EXT[15]),
			CheckboxFilter(316, TAGS_FILTER_EXT[16]),
			CheckboxFilter(317, TAGS_FILTER_EXT[17]),
			CheckboxFilter(318, TAGS_FILTER_EXT[18]),
			CheckboxFilter(319, TAGS_FILTER_EXT[19]),
			CheckboxFilter(320, TAGS_FILTER_EXT[20]),
			CheckboxFilter(321, TAGS_FILTER_EXT[21]),
			CheckboxFilter(322, TAGS_FILTER_EXT[22]),
			CheckboxFilter(323, TAGS_FILTER_EXT[23]),
			CheckboxFilter(324, TAGS_FILTER_EXT[24]),
			CheckboxFilter(325, TAGS_FILTER_EXT[25]),
			CheckboxFilter(326, TAGS_FILTER_EXT[26]),
			CheckboxFilter(327, TAGS_FILTER_EXT[27]),
			CheckboxFilter(328, TAGS_FILTER_EXT[28]),
			CheckboxFilter(329, TAGS_FILTER_EXT[29]),
			CheckboxFilter(330, TAGS_FILTER_EXT[30]),
			CheckboxFilter(331, TAGS_FILTER_EXT[31]),
			CheckboxFilter(332, TAGS_FILTER_EXT[32]),
			CheckboxFilter(333, TAGS_FILTER_EXT[33]),
			CheckboxFilter(334, TAGS_FILTER_EXT[34]),
			CheckboxFilter(335, TAGS_FILTER_EXT[35]),
			CheckboxFilter(336, TAGS_FILTER_EXT[36]),
			CheckboxFilter(337, TAGS_FILTER_EXT[37]),
			CheckboxFilter(338, TAGS_FILTER_EXT[38]),
			CheckboxFilter(339, TAGS_FILTER_EXT[39]),
			CheckboxFilter(340, TAGS_FILTER_EXT[40]),
			CheckboxFilter(341, TAGS_FILTER_EXT[41]),
			CheckboxFilter(342, TAGS_FILTER_EXT[42]),
			CheckboxFilter(343, TAGS_FILTER_EXT[43]),
			CheckboxFilter(344, TAGS_FILTER_EXT[44]),
			CheckboxFilter(345, TAGS_FILTER_EXT[45]),
			CheckboxFilter(346, TAGS_FILTER_EXT[46]),
		}),
		FilterGroup("Content Warnings [TODO: TriStateFilter]", {
			CheckboxFilter(401, CONTENT_WARNINGS_FILTER_EXT[01]),
			CheckboxFilter(402, CONTENT_WARNINGS_FILTER_EXT[02]),
			CheckboxFilter(403, CONTENT_WARNINGS_FILTER_EXT[03]),
			CheckboxFilter(404, CONTENT_WARNINGS_FILTER_EXT[04]),
		}),
